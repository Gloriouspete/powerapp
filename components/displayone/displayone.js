            ...
            <View style={styles.previewbox}>
               ...
               <View style={styles.circlea}>
                ...
                <View style={styles.secondbox}>
                    ...
                    <Text style={styles.firsttext}>FAST AND EASY</Text>
                    <Text style={styles.secondtext}>Power pay bill provides you with a seamless and efficient transaction experience</Text>

                </View>
                <View style={styles.thirdbox}>
                    <View style={styles.boxcont}>
                        <Pressable style={styles.buttonstyle} onPress={() => navigation.navigate('Displaytwo')} >
